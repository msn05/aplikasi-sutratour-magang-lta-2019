   ...
   <div class="row">
    <div class="col-md-3">
     <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
      <li class="nav-item"> <a class="nav-link active" id="first-tab" data-toggle="tab" href="#firstTab" role="tab" aria-controls="firstTab" aria-selected="true">Daftar Promo</a> </li>
  ...
  <div class="col-md-9">
   <div class="tab-content my-3" id="myTabContentVertical">
    <div class="tab-pane fade show active" id="firstTab" role="tabpanel" aria-labelledby="first-tab">
     <div class="row">
      <div class="col-lg-12">
       <h4 class="mb-4">Promo Layanan</h4>
            ...
            <!-- <select class="form-control" id="start_date" name="start_date"> -->
              <select name="" id="start"  class="form-control">
               ...
               <?php foreach ($dp as $key) { ?>
                <option value="<?=$key->id_promo_layanan;?>"><?=$key->nama_layanan;?></option>
              <?php } ?>
            </select>
          </div> 
...
<script>
 ...
 $(document).ready(function() {
  $("#formC").submit(function(e){
   e.preventDefault();
   var id_promo_layanan = $("#start").val();
   var url = "<?=base_url('layanan/cari_promo/')?>" + id_promo_layanan ;
   $('#res').load(url);
