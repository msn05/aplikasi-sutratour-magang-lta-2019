...
<head>
 ...
 <link href="<?=base_url().'assets/html/vendors/bower_components/sweetalert/dist/sweetalert.css';?>" type="text/css">
 <link href="<?=base_url().'assets/depan/html/vendor/zoomple-master/style/zoomple.css';?>" type="text/css">
